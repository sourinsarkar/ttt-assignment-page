...
const followerKey: string | undefined =
  Object.keys(Data.profile).find(
    (key) => Data.profile[key] === Data.profile.follower
  ) + "s";
const followingKey: string | undefined = Object.keys(Data.profile).find(
  (key) => Data.profile[key] === Data.profile.following
);

const camelCaseFollowerKey = followerKey ? toCamelCase(followerKey) : undefined;
const camelCaseFollowingKey = followingKey
  ? toCamelCase(followingKey)
  : undefined;
            ...
            <div>
              ...
              <div className="flex justify-between gap-4">
                <div className="w-full flex">
                  <Stats
                    value={Data.profile.follower}
                    statTopic={camelCaseFollowerKey}
                  />
                </div>
                ...
                <div className="w-full flex">
                  <Stats
                    ...
                    statTopic={camelCaseFollowingKey}
                  />
                </div>
              </div>
            </div>
